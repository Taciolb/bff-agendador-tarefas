package com.tlbtech.bffagendadortarefas.controller;


import com.tlbtech.bffagendadortarefas.business.UsuarioService;
...
public class UsuarioController {
    ...
    public ResponseEntity<EnderecoDTOResponse> atualizaEndereco(@RequestBody EnderecoDTORequest dto,
                                                                ...
                                                                @RequestHeader(name = "Authorization", required = false) String token) {
        return ResponseEntity.ok(usuarioService.atualizaEndereço(id, dto, token));
    }

    @PutMapping("/telefone")
    @Operation(summary = "Atualiza Telefone de Usuários", description = "Atualiza Telefone usuário")
